...
def convert_patch_call_to_diff(file_path: str, orig: str, new: str) -> str:
    """Format patch call into a valid unified git diff string."""
    diff_lines = [
        ...
        for turn in range(max_turns):
            ...
            for call in found_calls:
                ...
                if tool_name == "get_error_context":
                    ...
                    synthesized_patch = convert_patch_call_to_diff(f_path, orig, new_code)
